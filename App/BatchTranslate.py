...
class BatchTranslate(Optimize):
    def __init__(self, langExpression: str, splitExpression: str, includefilter: list[str], excludeFilter: list[str], maxChar: int):
        # mental node: patterns list should be overworked with regex for better runtime
        super().__init__(langExpression, splitExpression, includefilter, excludeFilter)
